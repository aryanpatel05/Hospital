...
const NotFound = () => {
  useEffect(() => {
    // Reveal the SVG when the component mounts
    gsap.set(`.${styles.GapSVG}`, { visibility: "visible" });
  ...
  return (
    <main className={styles.GapMain}>
      ...
      <div className={styles.GapRight}>
        <h1 className={styles.GapH1}>404</h1>
        <h2 className={styles.GapH2}>UH OH! You're lost.</h2>
        <p className={styles.GapP}>
          The page you are looking for does not exist. But you can click the
          button below to go back to the homepage.
        </p>
        <button className={styles.GapBtn} onClick={handleHomeClick}>
          HOME
        </button>
      </div>
    </main>
